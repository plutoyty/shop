...
public class GoodsSearch {
    ...
    public  final String INDEXPATH = "D://indexFile//dbIndex";
    ...
    public  boolean createIndex() {
        try {
            ...
            String query = "select pk_id,idx_name,idx_subtitle from t_goods";
            ps = con.prepareStatement(query);
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                Document doc = new Document();
                String id = rs.getString("pk_id");
                String name = rs.getString("idx_name");
                String subtitle = rs.getString("idx_subtitle");
...
//                doc.add(new TextField("tag", tsg, Field.Store.YES));
                ...
                doc.add(new TextField("subtitle", subtitle, Field.Store.YES)); // 做analyze
//                doc.add(new TextField("content", content, Field.Store.YES));
    ...
    private int TOP_NUM = 100; // 显示记录数

    public  List<String> searchData(String queryStr) {
...
//            Highlighter highlighter = new Highlighter(formatter, scorer);
    ...
    public  List<String> searchData(String queryStr, String fieldString) {
        List<String> list = new ArrayList<>();
        Directory dir = null;
        try {
            dir = FSDirectory.open(Paths.get(INDEXPATH));
